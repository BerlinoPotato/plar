import json, os, sys, threading, subprocess, shlex, time, signal
...
class ToolEditor(QtWidgets.QDialog):
    def __init__(self, parent=None, tool: Optional[ToolSpec]=None):
        ...
        # self.output_opt  = QtWidgets.QCheckBox("Output folder optional"); self.output_opt.setChecked(self.tool.output_dir_optional)       #beeee
    ...
    def __init__(self, parent=None):
        ...
        form_box.setStyleSheet("""
            QGroupBox {
                ...
                border-radius: 10px;
                background:#80BEE8F7;               /* #80BEE8F7 beeeered */  
...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self, tools: List[ToolSpec]):
        ...
        # cur_mode = QtCore.QSettings("BeePiton", "LocalAppRunner").value("theme", "auto")
    ...
    def _switch_theme(self, mode: str):
        ...
        QtCore.QSettings("BeePiton", "LocalAppRunner")
        if self.statusBar():
...
def apply_modern_theme(app: QtWidgets.QApplication, mode: str = "light"):
    ...
    app.setStyleSheet("""
        ...
        QListWidget {
            ...
            padding: 8px;
            outline: none;
            background-color: #80BEE8F7 ;        /* #80BEE8F7 beeee transparent with slight tint blue */
        }
        QListWidget::item {
            padding: 8px 10px;
            border-radius: 8px;
            margin: 2px 0;
            background-color: #33BEE8F7;        /*  #33BEE8F7 beeee transparent with slight tint blue */
        }
...
def main():
    ...
    # settings = QtCore.QSettings("BeePiton", "LocalAppRunner")
